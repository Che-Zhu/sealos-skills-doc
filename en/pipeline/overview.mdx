...
Phase 5 runs before Phase 6. `.sealos/template/index.yaml` must exist. The agent collects inputs, records user confirmation, and dry-runs the final YAML. Deploy proceeds only after precheck passes.
...
| --- | --- | --- |
| [Phase 0](/en/pipeline/phases/phase-0-preflight) | Preflight | Environment, identity, source directory |
| [Phase 1](/en/pipeline/phases/phase-1-assess) | Assess | Judge deployability, choose path |
| [Phase 2](/en/pipeline/phases/phase-2-discover) | Discover | agentlens, `deployment-plan.json` |
...
| [Phase 5](/en/pipeline/phases/phase-5-prepare) | Pre-deploy preparation | Collect inputs, confirm, dry-run (template ready) |
